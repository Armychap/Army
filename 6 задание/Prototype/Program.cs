...
registry.Register("login-bug", template); // Объект template выступает как прототип задачи.
...
manager.CopyFromTemplate("login-bug"); // Clone() выполняется внутри
...
static void Print(TaskItem task)
{
